...
const ProfileDetailed = () => {
  ...
  const [description, setDescription] = useState(
    'This is my description. Have a nice day. ✌️'
  );
    ...
    <div className='w-full flex flex-col flex-grow bg-gradient-to-tl to-green-950 from-cstm_bg_dark overflow-y-auto font-poppins selection:bg-accent_green_dark selection:text-cstm_white relative'>
      ...
      >
        <p className='font-medium select-none'>
          You are editing your profile now!
        </p>
      </div>

      <section className='w-full h-screen min-h-screen flex flex-col justify-start items-center'>
        <div className='w-full h-fit flex justify-between items-center p-4'>
          <BackButton to='/study-sets' className='h-fit' />
          <ProfileEditButton
              ...
              {isEditing && (
                <>
                  ...
                  <label
                    ...
                    className='absolute w-full aspect-square bg-slate-900/80 rounded-full flex items-center justify-center cursor-pointer z-10'
                  >
