...
const DeleteButton = ({ isWide, itemName, onClick }) => {
    ...
    return (
        <div
            className={`${isWide ? 'w-full h-fit rounded-b-xl' : 'w-fit h-fit rounded-xl'} flex justify-center items-center duration-500 cursor-pointer gap-2 px-2 py-2 select-none ${isHovered ? 'bg-red-700' : ''}`}
